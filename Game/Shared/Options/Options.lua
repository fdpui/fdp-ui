...
NUI.options = {
    ...
    args = {
        profiles_classic = {
            ...
            order = 1,
            hidden = function()
                if NUI.Retail or NUI:IsAddOnEnabled("ElvUI") or not AreAddOnsEnabled() or InCombatLockdown() then
        ...
        profiles_retail = {
            ...
            order = 1,
            hidden = function()
                if not NUI.Retail or NUI:IsAddOnEnabled("ElvUI") or InCombatLockdown() then
        ...
        general_weakauras = {
            ...
            order = 2,
            hidden = function()
                if NUI.Retail or not NUI:IsAddOnEnabled("WeakAuras") or InCombatLockdown() then
