...
local function ImportElvUI(addon, resolution)
    ...
    SE:RebrandImportData(data)

    DI:SetImportedProfile(profileType, "FDP", data, true)
    E:SetupCVars(true)
...
local function ImportWindTools(resolution)
    ...
    E.private.WT.skins.bigWigsSkin.queueTimer.countDown.name = "FDP"
    ...
    E.private.WT.skins.ime.label.name = "FDP"
    ...
    E.private.WT.skins.widgets.button.backdrop.texture = "FDPLeft"
    ...
    E.private.WT.skins.widgets.tab.backdrop.texture = "FDPLeft"
    ...
    E.private.WT.skins.widgets.treeGroupButton.backdrop.texture = "FDPLeft"
...
function SE.ElvUI(addon, import, resolution)
    ...
    E.private.general.chatBubbleFont = "FDP"
    ...
    E.private.general.glossTex = "FDPLeft"
    E.private.general.minimap.hideTracking = true
    E.private.general.namefont = "FDP"
    E.private.general.normTex = "FDPLeft"
