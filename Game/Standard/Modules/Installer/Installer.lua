...
I.installer = {
    Title = "FDPUI Installation",
    Name = "FDPUI",
    tutorialImage = "Interface\\AddOns\\FDPUI\\Game\\Shared\\Media\\Textures\\LogoTop.tga",
    Pages = {
        [1] = function()
        ...
        [7] = function()
            PluginInstallFrame.SubTitle:SetText("FDPQOL")
            ...
            PluginInstallFrame.Desc2:SetText("Click on the button representing the resolution of your choice to setup FDPQOL")
            PluginInstallFrame.Option1:Show()
            PluginInstallFrame.Option1:SetScript("OnClick", function() SE:Setup("FDPQOL", true) end)
            PluginInstallFrame.Option1:SetText("1440p")
            PluginInstallFrame.Option2:Show()
            PluginInstallFrame.Option2:SetScript("OnClick", function() SE:Setup("FDPQOL", true, "1080p") end)
            PluginInstallFrame.Option2:SetText("1080p")
        end,
        [8] = function()
